 ...
 * @return	A yarray of matching nodes.
 */
 ...
 * @param	nodes	An array of XML nodes from where the XPath
 *			search must be done.
 * @param	xpath	The XPath expression.
 * @return	An array of XML nodes that matches the XPath.
 */
