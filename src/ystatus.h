 ...
 * @discussion	The type ystatus_t is a convenient way to transmit error values.
 *		When a ystatus_t value is zero, there is no error. If it is
 *		a positive or negative integer, there is an error. When a function
 *		have to return an error code, it must return YENOERR in case
 *		of success, or a code that depend of the occuring error.
 *		Any user defined error should have a positive value greater than
 *		1 (1 is the value for undefined errors).
...
#define	YENOMEM			(-12)
/** @define YEACCES Permission denied. */
#define	YEACCES			(-13)
...
/** @define YECANCELED Operation Canceled. */
#define YYECANCELED		(-125)
/** @define YENOKEY Required key not available. */
#define YENOKEY			(-126)
/** @define YEKEYEXPIRED Key has expired. */
#define YEKEYEXPIRED		(-127)
/** @define YEKEYREVOKED Key has been revoked. */
#define YEKEYREVOKED		(-128)
/** @define YEKEYREJECTED Key was rejected by service. */
#define YEKEYREJECTED		(-129)
/** @define YEOWNERDEAD Owner died (for mutexes). */
#define YEOWNERDEAD		(-130)
/** @define YENOTRECOVERABLE State not recoverable. */
#define YENOTRECOVERABLE	(-131)
/** @define YERFKILL Operation not possible due to RF-kill. */
#define YERFKILL		(-132)
/** @define YEHWPOISON Memory page has hardware error. */
#define YEHWPOISON		(-133)

/* Custom errors (not inspired from errno.h). */
/** @define YESYNTAX Syntax error. */
#define YESYNTAX		(-65536)
/** @define YEPARAM Bad parameter. */
#define YEPARAM			(-65537)
/** @define YEBADCONF Bad configuration. */
#define YEBADCONF		(-65538)
/** @define YECOMPRESS Compression error. */
#define YECOMPRESS		(-65539)
/** @define YECRYPT Encryption error. */
#define YECRYPT			(-65540)
